...
const MultiStepForm = ({
  ...
  const onFinish = () => {
    ...
    const messageTitle =
      questions?.length == 1
        ? "Estas seguro que deseas enviar tu respuesta?"
        : "Estas seguro que deseas enviar tus respuestas?";
    const messageText =
      questions?.length == 1
        ? "No podras modificar la respuesta una vez enviada"
        : "No podras modificar las respuestas una vez enviadas";
  ...
  return (
    <div className="glass-bg p-4">
      <Form form={form} disabled={formDisabled} style={{ minHeight: "30vh" }}>
        <div className="row">
          <div className="col-12 col-md-12 overflow-auto">
        ...
        <div className="d-md-flex border-top pt-3">
          <div>
            <Checkbox
              ...
              onChange={anonymousResponseHandler}
            >
          ...
          <div className="steps-action ms-auto mt-3 mt-md-0">
            ...
            {currentStep === questionsForm?.length - 1 && (
              <Button
                type="primary"
                disabled={
                  buttonDisabled ? buttonDisabled : submitButtonDisabled
                }
