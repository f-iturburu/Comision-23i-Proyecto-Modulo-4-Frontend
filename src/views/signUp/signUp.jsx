  ...
  const handleSubmit = async (e) => {
    ...
    if (passwordRef.current.value !== repeatPasswordRef.current.value) {
      return setErrorMessage(
        <AlertDismissible message={"Las contraseñas no coinciden."} />
      );
    }
      ...
      <Container className="p-4 glass-bg">
        <Form className="my-5" onSubmit={handleSubmit}>
          ...
          <Form.Group className="mb-3">
            ...
            <Form.Text className="text-light" muted>
              Su contraseña debe ser de un minimo de 8 caracteres y debe
              contener al menos una letra y un número, no se permiten espacios
          ...
          <div className="d-flex">
            <Button className="ms-auto" type="primary" onClick={handleSubmit}>
              {!loading ? (
                "Registrarme"
              ) : (
                <>
